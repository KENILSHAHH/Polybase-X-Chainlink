...
fetchUserData();
  ...
  const fetchUserData = async () => {
    await fetch(
      'https://testnet.polybase.xyz/v0/collections/pk%2F0x19048fb81d19b5e3285d29b583b9a21bdad8b423280bea15e80a2488d9ab2f2d471c9d1d84acf2e32ae0fcd62a6916b25def11fc9cbe40df3c6f5f8e8a1f458a%2FToDoApp%2FUser/records'
    )
      .then(async (response) => {
...
`,
    ...
    console.log('Request transaction hash: ', requestTx);
    setTimeout(async () => {
    console.log(dataEntry);
    await setDataEntry(dataEntry+1);
    console.log(dataEntry);
    }, 15000);
